...
@Component({
  ...
  template: `
        ...
        <div class="ai-intro-content">
          ...
          <div class="ai-description">
            ...
            <ul class="feature-list">
              <li>✨ <strong>Secure Dataset Exposure:</strong> Safely expose your datasets to AI clients with full RBAC protections</li>
              <li>🔐 <strong>Enterprise-Grade Security:</strong> Maintain complete control over data access and permissions</li>
              <li>🚀 <strong>Seamless Integration:</strong> Connect popular AI platforms and tools directly to your DreamFactory APIs</li>
              <li>📊 <strong>Intelligent Analytics:</strong> Generate insights and recommendations powered by machine learning</li>
            </ul>
            <div class="beta-callout">
              <h3>🎯 Ready to Get Started?</h3>
              <p>Contact us below to join our exclusive AI beta program and be among the first to experience these cutting-edge capabilities!</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <ng-template #allowed>
      <div class="ai-container">
        <h1>AI Assistant</h1>
        <p>Welcome to the AI section! This is where AI-powered features will be implemented.</p>
  ...
  styles: [`
    ...
    h1 {
      color: #333;
      margin-bottom: 1rem;
      background: linear-gradient(45deg, #dc143c, #ff4500, #ffa500, #32cd32, #1e90ff, #8a2be2);

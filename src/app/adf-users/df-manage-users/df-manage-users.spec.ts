...
describe('DfManageUsersComponent', () => {
  ...
  it('should call uploadUserList on file input change', () => {
    const input = fixture.nativeElement.querySelector('input[type="file"]');
    jest.spyOn(component.manageUserTableComponent, 'uploadUserList');

    input.dispatchEvent(new Event('change'));

    expect(
      component.manageUserTableComponent.uploadUserList
    ).toHaveBeenCalled();
  });
});

/**
 * Global Lookup Keys Client Component (Simplified)
 * 
    ...
    <Modal isOpen={isOpen} onClose={onCancel} title={title}>
      ...
      <div className="flex justify-end space-x-3">
        ...
        <button
          onClick={onConfirm}
          disabled={isLoading}
          className={`px-4 py-2 text-sm font-medium rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 disabled:opacity-50 disabled:cursor-not-allowed ${confirmButtonClass}`}
        >
          {isLoading ? (
          ...
          <div className="ml-3">
            ...
            <div className="mt-3">
              <button
                ...
                className="bg-red-100 hover:bg-red-200 dark:bg-red-800 dark:hover:bg-red-700 text-red-800 dark:text-red-200 px-3 py-1 rounded-md text-sm font-medium transition-colors duration-200"
              >
                Try Again
              </button>
            </div>
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center space-x-3">
            ...
            {selectionStatus.selectedCount > 0 && (
              <button
                ...
                disabled={isMutating}
                className="bg-red-600 hover:bg-red-700 disabled:opacity-50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-md text-sm font-medium transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2"
              >
                <svg className="w-4 h-4 mr-2 inline" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="grid grid-cols-12 gap-4 items-center">
                      ...
                      <div className="col-span-1 flex items-center justify-end space-x-2">
                        ...
                        <button
                          ...
                          disabled={isMutating}
                          className="text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300 disabled:opacity-50 disabled:cursor-not-allowed p-1 rounded focus:outline-none focus:ring-2 focus:ring-red-500"
      ...
      <Modal 
        ...
        title={state.formMode === 'create' ? 'Create New Lookup Key' : 'Edit Lookup Key'}
      >
        <LookupKeysForm
